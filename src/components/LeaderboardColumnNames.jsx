...
const LeaderboardColumnNames = (props) => {
	return (
		<div
			className={cn(
				"grid grid-cols-[50px_auto_70px_20px] md:grid-cols-[100px_auto_40px_54px_100px_40px] text-xs md:text-base gap-3 bg-cswhitebright dark:bg-darkcswhitebright text-center font-poppins py-2 px-4 text-csgraydark sticky z-[2] list-none",
